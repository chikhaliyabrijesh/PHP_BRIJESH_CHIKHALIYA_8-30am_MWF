<?php
$mainurl="http://localhost/assessment_lms/";
$baseurl="http://localhost/assessment_lms/assets/";
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='<?php echo $baseurl;?>css/bootstrap-grid.css'>
...
<body>
    <div class="container mt-4">
        <div class="row">
          <div class="col-md-3">
            <p><b>Call us</b> <i class="bi bi-telephone"></i> (+91)999-800-3879</p>
          </div>
          ...
          <div class="col-md-4">
            <p><b>Email</b> <i class="bi bi-envelope"></i> <a href="mailto:info@gmail.com">info@gmail.com</a>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
            <b>
