...
class model
{
    ...
    public function updatedata($table,$path,$fnm,$lnm,$dob,$pn,$em,$add,$st,$ct,$column,$register_id)
    {
        $update="update $table set photo='$path',first_name='$fnm',last_name='$lnm',dob='$dob',phone='$pn',email='$em',address='$add',state='$st',city='$ct' where $column='$register_id'";
        $execute=mysqli_query($this->connection,$update);
        return $execute;
    }
