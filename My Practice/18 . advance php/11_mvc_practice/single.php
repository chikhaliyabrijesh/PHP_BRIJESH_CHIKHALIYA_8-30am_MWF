			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="<?php echo $baseurl;?>images/si.jpg">
								<div class="thumb-image"> <img src="<?php echo $baseurl;?>images/si.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="<?php echo $baseurl;?>images/si1.jpg">
								<div class="thumb-image"> <img src="<?php echo $baseurl;?>images/si1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="<?php echo $baseurl;?>images/si2.jpg">
							<div class="thumb-image"> <img src="<?php echo $baseurl;?>images/si2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
						</ul>
					</div>
				</div>
		  ...
		  <div class="response">
						<div class="media response-info">
							<div class="media-left response-text-left">
								<a href="#">
									<img class="media-object" src="<?php echo $baseurl;?>images/icon1.png" alt="" />
								</a>
							...
							<div class="media-body response-text-right">
								...
								<ul>
									<li>MARCH 21, 2015</li>
									<li><a href="<?php $mainurl;?>single">Reply</a></li>
								</ul>
							</div>
							<div class="clearfix"> </div>
						</div>
