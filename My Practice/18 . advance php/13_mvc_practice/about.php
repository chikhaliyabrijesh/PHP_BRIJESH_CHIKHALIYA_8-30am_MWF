				...
				<div class="col-md-8 about-wthree-grids grid-top">
					...
					<div class="about-w3agilerow">
						<div class="col-md-4 about-w3imgs">
							<img src="<?php echo $baseurl;?>images/p3.jpg" alt="" class="img-responsive zoom-img"/>
						</div>
						<div class="col-md-4 about-w3imgs">
							<img src="<?php echo $baseurl;?>images/p4.jpg" alt=""  class="img-responsive zoom-img"/>
						</div>
						<div class="col-md-4 about-w3imgs">
							<img src="<?php echo $baseurl;?>images/p3.jpg" alt=""  class="img-responsive zoom-img"/>
						</div>
		...
		<div class="container">
			...
			<div class="team-agileitsinfo">
				<div class="col-md-3 about-team-grids">
					<img src="<?php echo $baseurl;?>images/t4.jpg" alt=""/>
				...
				<div class=" col-md-3 about-team-grids">
					<img src="<?php echo $baseurl;?>images/t2.jpg" alt=""/>
					<div class="team-w3lstext">
				...
				<div class="col-md-3 about-team-grids">
					<img src="<?php echo $baseurl;?>images/t1.jpg" alt=""/>
					<div class="team-w3lstext">
				...
				<div class="col-md-3 about-team-grids">
					<img src="<?php echo $baseurl;?>images/t3.jpg" alt=""/>
					<div class="team-w3lstext">
