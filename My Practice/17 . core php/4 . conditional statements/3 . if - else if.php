...
if(isset($_POST["sub"]))
{
    ...
    if($s1>=33 && $s2>=33 && $s3>=33 && $s4>=33 && $s5>=33)
    {
...

        {
            if($pr>=90)
            {
                echo "<h1 align='center'>Grade A &#128526</h1>";
            }
            else if($pr>=80 && $pr<90)
            {
                echo "<h1 align='center'>Grade B &#128522</h1>";
            }
            else if($pr>=70 && $pr<80)
            {
                echo "<h1 align='center'>Grade C &#128521</h1>";
            }
            else if($pr>=60 && $pr<70)
            {
                echo "<h1 align='center'>Grade D &#128528</h1>";
            }   
            else if($pr>=35 && $pr<60)
            {
                echo "<h1 align='center'>Grade E &#128524</h1>";
            }
            else
            {
                echo "<h1 align='center'>You Are Fail &#128531</h1>";
            }
        }
    }
    else
