                ...
                <table class="table table-striped  table-borderless table-hover mt-3">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo "./editdata";?>?editdataid=<?php echo $row["product_id"];?>"><button type="button" class="btn btn-sm btn-info text-white"><i class="bi bi-pencil-square">&nbsp;Edit</i></button></a> 
